...
int perform_compression(u8 *in, int zsize, u8 **ret_out, int size, int *outsize) {
    ...
    switch(compression_type) {
        ...
        case COMP_TONY: {
            size = Screen__decompressTony(in, zsize, out, size);
            break;
        }
        case COMP_RLE7: {
            size = Screen__decompressRLE7(in, zsize, out, size);
            break;
        }
        case COMP_RLE0: {
            size = Screen__decompressRLE0(in, zsize, out, size);
            break;
        }
        case COMP_RLE: {
        ...
        case COMP_PUYO_CNX: {
            size = puyo_cnx(in, zsize, out, size);  // _unpack is the old one
            break;
        }
        case COMP_PUYO_CXLZ: {
        ...
        case COMP_PUYO_LZ00: {
            size = puyo_lz00(in, zsize, out, size); // _unpack is the old one
            break;
        }
        case COMP_PUYO_LZ01: {
            size = puyo_lz01(in, zsize, out, size); // _unpack is the old one
            break;
        }
        case COMP_PUYO_LZSS: {
        ...
        case COMP_PUYO_PRS: {
            size = puyo_prs(in, zsize, out, size);  // _unpack is the old one
            break;
        }
        //case COMP_PUYO_PVZ: {
        ...
        case COMP_LUNAR_LZ1:  { size = lunar_uncompress(in, zsize, out, size, LC_LZ1,  myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_LZ2:  { size = lunar_uncompress(in, zsize, out, size, LC_LZ2,  myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_LZ3:  { size = lunar_uncompress(in, zsize, out, size, LC_LZ3,  myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_LZ4:  { size = lunar_uncompress(in, zsize, out, size, LC_LZ4,  myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_LZ5:  { size = lunar_uncompress(in, zsize, out, size, LC_LZ5,  myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_LZ6:  { size = lunar_uncompress(in, zsize, out, size, LC_LZ6,  myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_LZ7:  { size = lunar_uncompress(in, zsize, out, size, LC_LZ7,  myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_LZ8:  { size = lunar_uncompress(in, zsize, out, size, LC_LZ8,  myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_LZ9:  { size = lunar_uncompress(in, zsize, out, size, LC_LZ9,  myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_LZ10: { size = lunar_uncompress(in, zsize, out, size, LC_LZ10, myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_LZ11: { size = lunar_uncompress(in, zsize, out, size, LC_LZ11, myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_LZ12: { size = lunar_uncompress(in, zsize, out, size, LC_LZ12, myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_LZ13: { size = lunar_uncompress(in, zsize, out, size, LC_LZ13, myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_LZ14: { size = lunar_uncompress(in, zsize, out, size, LC_LZ14, myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_LZ15: { size = lunar_uncompress(in, zsize, out, size, LC_LZ15, myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_LZ16: { size = lunar_uncompress(in, zsize, out, size, LC_LZ16, myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_LZ17: { size = lunar_uncompress(in, zsize, out, size, LC_LZ17, myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_LZ18: { size = lunar_uncompress(in, zsize, out, size, LC_LZ18, myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_RLE1: { size = lunar_uncompress(in, zsize, out, size, LC_RLE1, myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_RLE2: { size = lunar_uncompress(in, zsize, out, size, LC_RLE2, myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_RLE3: { size = lunar_uncompress(in, zsize, out, size, LC_RLE3, myatoi(comtype_dictionary));     break; }
        case COMP_LUNAR_RLE4: { size = lunar_uncompress(in, zsize, out, size, LC_RLE4, myatoi(comtype_dictionary));     break; }
        case COMP_GOLDENSUN: {
        ...
        //case COMP_SCUMMVM1:  size = Screen__decompressTony(in, zsize, out, size); break;
        //case COMP_SCUMMVM2:  size = Screen__decompressRLE7(in, zsize, out, size); break;
        //case COMP_SCUMMVM3:  size = Screen__decompressRLE0(in, zsize, out, size); break;
        case COMP_SCUMMVM4:  size = Screen__decompressHIF(in, out); break;
        case COMP_SCUMMVM5:  size = decompressSPCN(in, out, size); break;
        case COMP_SCUMMVM6:  size = RncDecoder__unpackM1(in, zsize, out, size); break;   // RNC1
        case COMP_SCUMMVM7:  size = RncDecoder__unpackM2(in, zsize, out, size); break;   // RNC2
        case COMP_SCUMMVM8:  size = CineUnpacker__unpack(in, zsize, out, size); break;
        case COMP_SCUMMVM9:  size = delphineUnpack(out, size, in, zsize); break;
        case COMP_SCUMMVM10: size = DataIO__unpackChunk(in, out, size); break;
        case COMP_SCUMMVM11: size = DecompressorHuffman__unpack(in, out, zsize, size); break;
        case COMP_SCUMMVM12: size = DecompressorLZW__unpackLZW(in, out, zsize, size); break;
        case COMP_SCUMMVM13: size = DecompressorLZW__unpackLZW1(in, out, zsize, size); break;
        case COMP_SCUMMVM14: size = DecompressorLZW__reorderPic(in, out, size); break;
        case COMP_SCUMMVM15: size = DecompressorLZW__reorderView(in, out); break;
        case COMP_SCUMMVM16: size = DecompressorLZS__unpack(in, out, zsize, size); break;
        case COMP_SCUMMVM17: size = decodeSRLE(out, in, size); break;
        case COMP_SCUMMVM18: size = Screen__unpackRle(in, out, size); break;
        case COMP_SCUMMVM19: size = PS2Icon__decompressData(in, zsize, out, size); break;
        case COMP_SCUMMVM20: size = LZWDecoder__lzwExpand(in, out, size); break;
        case COMP_SCUMMVM21: size = uncompressPlane(in, out, size); break;
        case COMP_SCUMMVM22: size = unbarchive(in, zsize, out); break;
        case COMP_SCUMMVM23: size = Screen__decompressRLE256(out, in, size); break;
        case COMP_SCUMMVM24: size = Screen__decompressHIF_other(in, out /*, uint32 *skipData*/); break;
        case COMP_SCUMMVM25: size = FileExpander__process(out, in, size, zsize); break;
        case COMP_SCUMMVM26: size = SoundTownsPC98_v2__voicePlay(in, out, size); break;
        case COMP_SCUMMVM27: size = VQAMovie__decodeSND1(in, zsize, out, size); break;
        case COMP_SCUMMVM28: size = Background__decodeComponent(in, zsize, out, size); break;
        case COMP_SCUMMVM29: size = AnimFrame__decomp34(in, out, size, 0x7, 3); break;
        case COMP_SCUMMVM30: size = AnimFrame__decomp34(in, out, size, 0xf, 4); break;
        case COMP_SCUMMVM31: size = AnimFrame__decomp5(in, out, size); break;
        case COMP_SCUMMVM32: size = AnimFrame__decomp7(in, out, size); break;
        case COMP_SCUMMVM33: size = AnimFrame__decompFF(in, out, size); break;
        case COMP_SCUMMVM34: size = SavegameStream__readCompressed(in, out, size); break;
        case COMP_SCUMMVM35: size = dimuse_compDecode(in, out); break;
        case COMP_SCUMMVM36: size = decompressADPCM(in, out, 1); break;
        case COMP_SCUMMVM37: size = decompressADPCM(in, out, 2); break;
        case COMP_SCUMMVM38: size = MohawkBitmap__unpackRiven(in, zsize, out); break;
        case COMP_SCUMMVM39: size = MohawkBitmap__drawRLE8(in, out, size); break;
        case COMP_SCUMMVM40: size = LzhDecompressor__decompress(in, out, zsize, size); break;
        case COMP_SCUMMVM41: size = AnimationDecoder__decode_data(in, zsize, out); break;
        case COMP_SCUMMVM42: size = MusicPlayerMac_t7g__decompressMidi(in, zsize, out, size); break;
        case COMP_SCUMMVM43: size = StuffItArchive__decompress14(in, zsize, out, size); break;
        case COMP_SCUMMVM44: size = decompressIconPlanar(out, size, in); break;
        case COMP_SCUMMVM45: size = DrasculaEngine__decodeRLE(in, out /*, uint16 pitch*/); break;
        case COMP_SCUMMVM46: size = bompDecodeLine(out, in, size); break;
        case COMP_SCUMMVM47: size = bompDecodeLineReverse(out, in, size); break;
        case COMP_SCUMMVM48: size = ToucheEngine__res_decodeScanLineImageRLE(in, out, size); break;
        case COMP_SCUMMVM49: size = AnimationPlayer__rleDecode(in, out, size); break;
        case COMP_SCUMMVM50: size = Graphics__decodeRLE(out, size, in); break;
        case COMP_SCUMMVM51: size = MSRLEDecoder__decode8(in, zsize, out, size); break;
        case COMP_SCUMMVM52: size = unarj(in, zsize, out, size, 0); break;
        case COMP_SCUMMVM53: size = unarj(in, zsize, out, size, 1); break;
        case COMP_LZS_UNZIP: {
            if(!comtype_dictionary) {
                fprintf(stderr, "\n"
        ...
        case COMP_LEGEND_OF_MANA: size = legend_of_mana(in, zsize, out, size); break;
        case COMP_DIZZY: size = dizzy(in, zsize, out); break;
        case COMP_EDL1: size = EDLdec1(0, in, out, zsize, size, 0); break;
        case COMP_EDL2: size = EDLdec2(0, in, out, zsize, size, 0); break;
        case COMP_DUNGEON_KID: size = dungeon_kid(in, out); break;
        case COMP_FRONTMISSION2: size = frontmission2(in, zsize, out); break;
        case COMP_RLEINC1: size = rleinc1(in, zsize, out); break;
        case COMP_RLEINC2: size = rleinc2(in, zsize, out); break;
        case COMP_EVOLUTION: size = evolution_unpack(in, zsize, out, size); break;
        case COMP_PUYO_LZ10: size = puyo_lz10(in, zsize, out, size); break;
        case COMP_PUYO_LZ11: size = puyo_lz11(in, zsize, out, size); break;
        case COMP_NISLZS: size = nislzs(in, out, size); break;
        ...
        */
        ...
        case COMP_SFL_BLOCK_CHUNKED_COMPRESS: {
            size = MAXZIPLEN(size);
            myalloc(&out, size, outsize);
